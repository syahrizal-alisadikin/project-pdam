...
class Rw extends Authenticatable
{
    ...
    protected $fillable = ['rw_id', 'name', 'email', 'flag_marketplace', 'flag_bmt', 'flag_surket', 'password', 'alamat', 'fk_kelurahan_id', 'fk_kecamatan_id', 'fk_kota_id', 'fk_provinsi_id', 'no_rw'];
